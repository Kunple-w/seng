...
class DefaultProviderTest {
    ...
    void callMethodNotExisted() {
        ...
        ApiResult apiResult = provider.call(invocation);
        ServiceNoSuchMethodException exception = new ServiceNoSuchMethodException("Invocation(serviceName=com.github.seng.core.UserService, methodName=hello2, args=[world]) not existed");
    ...
    void callBizError3() throws Exception {
        ...
        ApiResult apiResult = provider.call(invocation);
        List<String> msgList = userService.search("seng", 2);
